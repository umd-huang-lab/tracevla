...
def get_train_strategy(
    ...
    action_loss_calculation: str = 'full' ### 'full': "original openvla way", 'action_token_only': 'constrain on 256 action tokens'
) -> TrainingStrategy:
    if train_strategy in TRAIN_STRATEGIES:
        ...
        strategy = strategy_cfg["cls"](
            ...
            action_loss_calculation=action_loss_calculation,
            **strategy_cfg["kwargs"],
        )
        return strategy
    else:
