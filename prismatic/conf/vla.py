...
### 8GPU sanity check
@dataclass
class Exp_DinoSigLIP_224px_Ours(Exp_SigLIP_224px_Bridge):
...
### 64 GPU tracevla config   
@dataclass
class Exp_64GPU_DinoSigLIP_224px_Ours(Exp_SigLIP_224px_Bridge):
...
class VLARegistry(Enum):
    ...
    DINOSIGLIP_224PX_MX_OURS = Exp_DinoSigLIP_224px_Ours
    DINOSIGLIP_64GPU_224PX_MX_OURS = Exp_64GPU_DinoSigLIP_224px_Ours
